...
export const metadata = {
  metadataBase: new URL('https://cms-dashboard-8.preview.emergentagent.com'),
  title: {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://cms-dashboard-8.preview.emergentagent.com',
    siteName: 'Usefulio',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              potentialAction: {
                '@type': 'SearchAction',
                target: 'https://cms-dashboard-8.preview.emergentagent.com/products?search={search_term_string}',
