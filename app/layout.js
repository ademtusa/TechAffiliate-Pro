...
export const metadata = {
  metadataBase: new URL('https://affiliate-admin-5.preview.emergentagent.com'),
  title: {
  ...
  openGraph: {
    type: 'website',
    locale: 'en_US',
    url: 'https://affiliate-admin-5.preview.emergentagent.com',
    siteName: 'Usefulio',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              potentialAction: {
                '@type': 'SearchAction',
                target: 'https://affiliate-admin-5.preview.emergentagent.com/products?search={search_term_string}',
